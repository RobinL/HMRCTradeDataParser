  ...
  d3.json("static/data.json", function(root) {
    ...
    function display(d) {
      ...
      .style("height", function(d) { return y(d.y + d.dy) - y(d.y)+"px"; }) //textdiv class allows us to style the text easily with CSS
      ...
      function transition(d) {
        ...
        t2.selectAll(".textdiv").style("display", "block").style("height", function(d) { return y(d.y + d.dy) - y(d.y)+"px"; }); /* added */
