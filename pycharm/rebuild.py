...
from uk_trade_data.write_eu_import_data import raw_eu_import_data_to_database
...
rebuild_from_file(specific_url_part="SMKM46",
	path_to_replacement_zip=r"backups_of_broken_website_files\SMKM460902_rl_manual_fix.zip",
	file_type= "eu_imports",
	month=2,
	year=2009,
	add_to_database_function=raw_eu_import_data_to_database)
